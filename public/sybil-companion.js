(function () {
  ...
  // ---------- markdown-ish renderer for reading text ----------
  ...
  // ---------- history capture (called from React via window.__sybilSave) ----------
  ...
  // ---------- export (clean printable doc -> Save as PDF) ----------
  ...
  function openProfiles() {
    openModal("Saved profiles", function (body) {
      var note = el("p", "sybil-note", "Save birth details once, then load them into any reading.");
  ...
  // ---------- wire buttons into the control panel ----------
